...
export class CasosTesteInicial {
  conferirPagina() {
    cy.url(TEXTO_INICIAL.PAGINA_INICIAL);
    cy.contains(LOC_INICAL.FRASE_PARCEIRO, TEXTO_INICIAL.FRASE_PARCEIRO);
  }
...
const casosTesteInicial = new CasosTesteInicial();
export default casosTesteInicial;
